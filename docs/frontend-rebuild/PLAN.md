...
| 样板验收 | 待用户确认 | T02-H/S集成 | 用户/A | pilotCommit 候选 `1a9aa2a`；64 格矩阵、20 张截图与逐项结论见 INTEGRATION.md「T02-S 服务页样板集成与样板验收矩阵」 |
| T03 | 待样板批准 | 样板批准 | C | — |
| T04 | 待样板批准 | 样板批准 | D | — |
| T05 | 待样板批准 | 样板批准 | B | — |
| T06 | 未开始 | 样板批准 | A | — |
...
本表按 INTEGRATION.md 已记录的合并提交更新（2026-09-15）；样板未获用户批准前 T03—T06 不启动。
